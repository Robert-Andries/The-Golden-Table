...
public sealed class Add : MoneyBaseTest
{
    [Fact]
    public void Should_AddMoney_Successfully()
    {
        // Arrange
    ...
    public void Should_NotAddMoney_DiffrentCurrency()
    {
        ...
        for (int i = 0; i < 100 && sut.Currency == original.Currency; i++)
        {
            if (i == 99)
            {
