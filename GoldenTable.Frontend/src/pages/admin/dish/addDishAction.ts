import { fetchCreateDish } from "../../../communication/createDish/fetchCreateDish";
import {
  hasMinLenght,
  isGreaterThen0,
  isValidCurrency,
...
export async function addAction(
  ...
  try {
    await fetchCreateDish(payload);
    output.success = true;
  } catch (error: unknown) {
    const errorMessage = error instanceof Error ? error.message : "Failed to create dish";
